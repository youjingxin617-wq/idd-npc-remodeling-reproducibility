...
sections = [
    ...
    ("Materials and Methods", [
        ...
        ("Single-cell preprocessing and integration", "Raw count matrices from GSE165722 were processed in R using Seurat [9]. Cells were filtered using standard quality-control metrics, normalized, and subjected to variable-feature selection and dimensionality reduction. Harmony was used for sample-level batch correction [10]. Cells were clustered and visualized with UMAP and t-SNE embeddings."),
        ("NPC extraction and subtype annotation", "Major cell populations were annotated manually according to canonical marker-gene patterns. NPC-like/stromal clusters were extracted for focused analysis, reclustered, and cleaned of obvious non-NPC contaminants. The final cleaned NPC subset contained 8,245 NPC-like cells and was annotated into seven NPC states: ECM/Adh-NPCs, Hom-NPCs, Eff-NPCs, Ht-NPCs, Fibro-NPCs, Fibro-reg NPCs, and Hom/Reg-like NPCs. The Hom/Reg-like NPC label was assigned to the reclustered state marked by CHRDL2, FRZB, WIF1, IGF2, and CLEC3A."),
        ("Ferroptosis-related module scoring", "FerrDb-derived ferroptosis driver and suppressor gene sets were used to calculate ferroptosis driver scores and ferroptosis suppressor scores in NPCs [11]. These scores were interpreted as transcriptomic gene-set scores rather than direct evidence of ferroptotic cell death."),
        ("Differential expression and enrichment", "Within each NPC subtype, severe and mild degeneration cells were compared using the Wilcoxon rank-sum test as implemented in Seurat [9]. Genes with adjusted p value < 0.05 and absolute average log2 fold change >= 0.25 were considered significant in this reproduction workflow. Severe-upregulated genes were submitted to Enrichr for GO Biological Process, KEGG, and Reactome enrichment analyses [12]."),
        ("External bulk validation, pseudotime, and communication inference", "Single-cell-derived biological modules were assessed in external bulk NP transcriptomes. In GSE70362, low-grade degeneration was defined as Thompson I/I-II/II NP samples and high-grade degeneration as Thompson IV/V NP samples; Thompson III samples were excluded. Slingshot was used for exploratory pseudotime analysis [13]. CellChat was used separately in mild and severe NPCs to infer NPC-NPC ligand-receptor communication [14,15]. These analyses were treated as hypothesis-generating and were not used to claim patient-level validation or experimental ligand-receptor activity.")
    ]),
    ("Results", [
